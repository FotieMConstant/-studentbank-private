<template>
  <div>
    <div class="text-gray-800 p-2 rounded-lg bg-white border border-gray-700 cursor-pointer">
      <!-- {{ $t('hello', { name: 'vue-i18n' }) }} -->
      <nuxt-img @click="showLangs = !showLangs" class="" :src="`../../../img/lang/${currentLang.icon}`" />
    </div>
</div>
<div v-show="showLangs" class="absolute right-0 -top-12 w-28 p-2 rounded-lg shadow sm:shadow-md bg-white cursor-pointer">
